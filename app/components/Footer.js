...
const mainPages = [
  ...
  { label: "Contact", href: "/services#book" },
];

const companyLinks = [
  { label: "Management & Support", href: "/services" },
      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-cta">
            ...
            <Link href="/services#book" className="footer-book-btn">
        ...
        <div className="footer-nav">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <Link href="/services">Service Plans</Link>
              </li>
              <li>
                <a href="tel:+966570563333">Emergency Support</a>
              </li>
              <li>
                <Link href="/services#book">Get a Quote</Link>
              </li>
            </ul>
          </div>

          <div className="footer-col">
            <h4 className="footer-col-title">Inquiry</h4>
            <ul className="footer-contact-list">
              <li>
                <a href="tel:+966570563333">057 056 3333</a>
              </li>
            </ul>
            <h4 className="footer-col-title footer-col-title--spaced">Location</h4>
          ...
          <div className="footer-col">
            <h4 className="footer-col-title">Service Area</h4>
            <ul>
